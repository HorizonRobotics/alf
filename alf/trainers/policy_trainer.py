...
"""
    ...
    if record_file is not None:
        ...
        # Skipping render will make randomness different from "human" mode.
        # Not using capture_frame as we don't want to record before reset().
    ...
    while episodes < num_episodes:
        ...
        episode_reward += float(torch.sum(time_step.reward))
