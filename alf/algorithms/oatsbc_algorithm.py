...
"""Optimistic Actor and Thompson Sampling Bayesian Critic Algorithm."""
...
@alf.configurable
class OatsbcAlgorithm(AbcAlgorithm):
    ...
    def __init__(self,
        ...
        """
        assert not deterministic_explorer, "The explore policy should be stochastic!"
        super().__init__(
            ...
            if self._training_started:
                ...
                if train:
                    ...
                    batch_idx = torch.arange(
                        action.shape[1]).type_as(action_idx)
