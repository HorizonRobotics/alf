...
from alf.algorithms.factored_ppo_algorithm import (
    FactoredPPOAlgorithm, FactoredPPOLoss, PartialValueNetwork)
...
class FactoredPpoTest(parameterized.TestCase, alf.test.TestCase):
