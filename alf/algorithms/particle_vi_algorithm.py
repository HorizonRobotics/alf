...
class ParVIAlgorithm(Algorithm):
    ...
    The particles are updated to minimize the following objective:
    ...
    distribution Q and the ``entropy_regularization`` is 1, this objective is equivalent to minimizing :math:`KL(P||Q)`.
    ...
    * entropy_regularization > 0: the minimization is achieved using amortized
      ...
      methods are implemented:
        ...
        2. Wasserstein ParVI with Smooth Functions (GFSF):
    ...
    def train_step(self,
        ...
        Args:
            ...
            transform_func (Callable): transform_func(particles) transforms the 
                particles to its corresponding function values evaluated on
