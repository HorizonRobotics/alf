...
class ModelAveragerTest(alf.test.TestCase):
    def test_double_averaged_model(self):
        model = nn.Sequential(nn.Linear(3, 4), nn.BatchNorm1d(4))

        averaged_model = create_averaged_model(model, "double")
        ...
        module = averaged_model._double_averaged_model.module.module
    ...
    def test_averaged_model(self):
        ...
        averaged_model = create_averaged_model(model, "single")
