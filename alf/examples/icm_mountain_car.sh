python actor_critic.py \
  ...
  --gin_param='create_algorithm.use_icm=1' \
  --gin_param='create_algorithm.actor_fc_layers=(256,)' \
  --gin_param='create_algorithm.value_fc_layers=(256,)' \
  --gin_param='create_algorithm.encoding_fc_layers=(200,)' \
  --gin_param='EncodingNetwork.activation_fn=@tf.nn.elu' \
  --gin_param='ICMAlgorithm.hidden_size=200' \
  --gin_param='on_policy_trainer.train.summarize_grads_and_vars=1' \
  --gin_param='on_policy_trainer.train.use_tf_functions=1' \
  --gin_param='on_policy_trainer.train.train_interval=100' \
