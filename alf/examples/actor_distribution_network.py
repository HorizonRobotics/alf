...
"""
Modify from tf_agent code to add support for multiple observations with encoder network
"""
...
class ActorDistributionNetwork(network.DistributionNetwork):
  ...
  def __init__(self,
    ...
    Args:
      ...
      output_tensor_spec: A nest of `tensor_spec.BoundedTensorSpec` representing
        the output.
      encoder: Optional encoder to handle complex observations.
  ...
  def call(self, observations, step_type, network_state):
    ...
    if self._encoder is None:
      ...
      states, network_state = self._encoder(observations, network_state=network_state)
