...
import alf
from alf.algorithms.reg_sac_algorithm import RegSacAlgorithm
...
# training config
alf.config("Agent", rl_algorithm_cls=RegSacAlgorithm)

alf.config('TrainerConfig',
           version='no-compensation',
           use_wandb=True,
           async_eval=True,
           entity="jiachenli",
           project="stable-rl",
