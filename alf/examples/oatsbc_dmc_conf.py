...
from alf.algorithms.oatsbc_algorithm import OatsbcAlgorithm
...
explore_network_cls = dmc_conf.actor_distribution_network_cls
...
alf.config('Agent', rl_algorithm_cls=OatsbcAlgorithm)
